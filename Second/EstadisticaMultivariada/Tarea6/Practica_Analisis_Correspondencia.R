# Practica 5. Aplicacion de análisis de correspondencia en R
library("MASS")
library("alr3")
library("stats")
...
#la tabla presenta la clasificacion de 5387 escolares escoceses por el color de sus ojos que tiene cuatro categorias: claros,azules,castaños y oscuros (I=4)
# y por el color de su cabello que tiene 5 categorias:rubio, pelirrojo,castaño,oscuro y negro (J=5).
...
#conclusion: el gráfico muestra  una relación clara entre ambas variables, es decir, existe dependencia entre las dos variables. La dimension principal gradua la tonalidad
#de claro a oscuro y la segunda separa los castaños de los demas
...
text (rl$points, labels=c ("<16", "16-17", "17-18", "18-19", "19-20") ,lwd=2)
